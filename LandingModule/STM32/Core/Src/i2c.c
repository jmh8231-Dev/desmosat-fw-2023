...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  */
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = IR_CAM_SCL_Pin|IR_CAM_CDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(IR_CAM_SCL_GPIO_Port, IR_CAM_SCL_Pin);

    HAL_GPIO_DeInit(IR_CAM_CDA_GPIO_Port, IR_CAM_CDA_Pin);
